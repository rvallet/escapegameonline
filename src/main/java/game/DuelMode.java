...
public class DuelMode {
    ...
    public void run(){
        ...
        if (!dmGame.getNumFound()){
            System.out.print(pr.getContent("content.duel.msg5"));
            System.out.println(cmGame.generateSecretNum());
            System.out.println(pr.getContent("content.duel.msg6")+dmGame.generateAnswer(dmHumanAnswer));
            }
        ...
        if (!cmGame.getNumFound()) {
            ...
            System.out.println(pr.getContent("content.dm.msg6"));
        } else {
